...
<% } %>
	...
	<div id="logreg-forms1" >
		<form class="form-findUserId" action="/semi/findUserId"  method="post"> <!--아이디 찾기-->
            <h1 class="h3 mb-3 font-weight-bold " style=" text-align: center"> 아이디 찾기</h1>
            	<input type="text" id="userName" name="username" class="form-control" placeholder="이름 입력" required="" autofocus="">
            	<input type="email" id="email" name="email" class="form-control" placeholder="이메일 입력" required="" autofocus="">

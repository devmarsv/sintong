...
<% } %>
	...
	<div id="logreg-forms1" >
		<form class="form-indmem_userid" action="/semi/findUserId"> <!--아이디 찾기-->
            <h1 class="h3 mb-3 font-weight-bold " style=" text-align: center"> 아이디 찾기 완료</h1>
            <div>
            	<h3>아이디 찾기 결과 아이디 정보는 아래와 같습니다.</h3>
            	<div>
            	 <h2>아이디 : <%= findId %> 입니다</h2>
            	</div>
            </div>	

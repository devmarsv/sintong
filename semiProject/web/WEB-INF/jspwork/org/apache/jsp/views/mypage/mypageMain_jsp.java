...
public final class mypageMain_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginMember == null) { 
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th width=\"35%\" style=\"text-align:center;vertical-align:middle;\">\r\n");
      out.write("\t\t\t\t\t\t\t<img src=\"/semi/resources/images/user.png\" width=\"100\">\r\n");
      out.write("\t\t\t\t\t\t\t<p style=\"margin-top:10px;\"><b style=\"font-weight:bold;\">");
      out.print( member.getMemName() );
      out.write("</b> 님</p>\r\n");
      out.write("\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t<td width=\"65%\" style=\"vertical-align:middle;\">\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"table\" style=\"margin-bottom:0;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th width=\"30%\" style=\"text-align:center;background:#edf1f5;\">아이디</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td width=\"70%\">");
      out.print( member.getMemUserid() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th style=\"text-align:center;background:#edf1f5;\">생일</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print( member.getMemBirth() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th style=\"text-align:center;background:#edf1f5;\">성별</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
 if(member.getMemGender().equals("F")){ 
      ...
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th style=\"text-align:center;background:#edf1f5;\">가입일</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print( member.getMemEnrolldate() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th style=\"text-align:center;background:#edf1f5;\">등급</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      ...
      out.write("\t\t\t\t\t<tr style=\"background:#c9d3dd;\">\r\n");
      out.write("\t\t\t\t\t\t<td align=\"center\" width=\"50%\"><i class=\"fas fa-coins\"></i> 포인트 <b style=\"font-weight:bold;\">");
      out.print( totalP );
      out.write("</b> P</td>\r\n");
      out.write("\t\t\t\t\t\t<td align=\"center\" width=\"50%\"><i class=\"fas fa-money-check-alt\"></i> 쿠폰 <b style=\"font-weight:bold;\">");
      out.print( totalC );
      out.write("</b> 장</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>");
      out.print( member.getMemTel() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>이메일</th>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( member.getMemEmail() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>주소</th>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( member.getMemAddr1() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
 if(member.getMemAddr2() != null) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>추가 주소</th>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( member.getMemAddr2() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
 } 

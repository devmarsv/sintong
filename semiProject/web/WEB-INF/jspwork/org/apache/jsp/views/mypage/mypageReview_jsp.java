 ...
 * Generated at: 2019-03-14 04:21:33 UTC
...
public final class mypageReview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("productReview.model.vo.MyPdReview");
 ...
 if(loginMember == null) { 
      ...
      out.write("\t\t\t\t\t\tlocation.replace('/semi/mrdel?no=' + $(this).attr('value') + '&userid=' + $(this).attr('data-value'));\r\n");
      out.write("\t\t\t\t\t} else{\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      ...
      out.write("\t\t\t<h2 class=\"conTit\">내가 쓴 후기(");
      out.print( listCount );
      out.write(")</h2>\r\n");
      out.write("\t\t\t<div>\r\n");
 ...
 if(mypList.size() == 0) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=3>작성된 후기가 없습니다.</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
 } else { 
      out.write("\r\n");
 ...
 for(MyPdReview mypr : mypList){ 
      ...
      out.write("\t\t\t\t\t\t\t \t<div class=\"pImg\" style=\"background:url(");
      out.print( mypr.getpImg() );
      out.write(") no-repeat center;background-size:cover;\">\r\n");
      out.write("\t\t\t\t\t\t\t \t</div>\r\n");
      out.write("\t\t\t\t\t\t\t \t<div class=\"pInfo\">\r\n");
      out.write("\t\t\t\t\t\t\t \t\t<strong class=\"pName\">");
      out.print( mypr.getpName() );
      out.write("</strong>\r\n");
      out.write("\t\t\t\t\t\t\t \t</div>\r\n");
      out.write("\t\t\t\t\t\t\t </td>\r\n");
      out.write("\t\t\t\t\t\t\t <td width=\"70%\">\r\n");
      out.write("\t\t\t\t\t\t\t \t<input type=\"hidden\" name=\"prnum\" value=\"");
      out.print( mypr.getpReviewNo() );
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t \t<input type=\"hidden\" name=\"userid\" value=\"");
      out.print( mypr.getMemUserid() );
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t \t<p>");
      out.print( mypr.getpReviewDate() );
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t \t<p>");
      out.print( mypr.getpReviewTitle() );
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t \t<p>");
      out.print( mypr.getMemUserid() );
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t \t<p>");
      out.print( mypr.getpReviewContent() );
      out.write("</p>\r\n");
      out.write("\t\t\t\t\t\t\t \t<div class=\"btBox\">\r\n");
      out.write("\t\t\t\t\t\t\t \t\t<a href=\"/semi/myprview?prnum=");
      out.print( mypr.getpReviewNo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("\" class=\"btModify\">수정</a>\r\n");
      out.write("\t\t\t\t\t\t\t \t\t<button name=\"delno\" data-value=\"");
      out.print( mypr.getMemUserid() );
      out.write("\" value=\"");
      out.print( mypr.getpReviewNo() );
      out.write("\" class=\"btDelete\">삭제</button>\r\n");
      out.write("\t\t\t\t\t\t\t \t</div>\r\n");
      out.write("\t\t\t\t\t\t\t </td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
 ...
 if((currentPage - 5) < startPage && (currentPage - 5) > 1){ 
      out.write("\r\n");
      out.write("\t\t\t\t      <a class=\"page-link\" href=\"/semi/mypreview?mem_userid=");
      out.print( loginMember.getMemUserid() );
      out.write("&page=");
